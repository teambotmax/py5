...
#line = LINE('EJpD2I9TZbu1ZELXku7f.cVaUT/YAr8Ww+9xrlrcwhW.BS/NGwx4OP8qcNwHIXm4Fqn1AJEtrbv3XcJpNZOsOus=')
...
print ("Login Succes Bot Pro-speed")
...
admin = "ud32fc6154159e31972a02df230ff5690" 
admin=['cb809b4416336a0cd70b21da339f2c6d6',lineMID]
...
settings = {
    ...
    "man2":"ตั้งข้อความ",
    "man3":"ตั้งข้อความ",
    "message":"บัญชีนี้ได้การป้องกัน💢โดย ☠️™>ທีಖএণЮ�༻ສາຢບ ິЊ☠ ระบบได้ทำการบล็อคคุณอัตโนมัติ",
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    ki.sendMessage(to, "😈_ຜู้คุມกาມlทW_😈 \nยังอยู่ครับ")
                elif text.lower() == 'เทส':
                    ...
                    line.sendMessage(to, " 🇹🇭⍣Pro-speed⍣🇹🇭ยังอยู่ครับ✔")
                    ...
                    start = time.time()
                    line.sendMessage(to,"ความเร็วของ 🇹🇭⍣ᏴᎾᎢ⅌pro⍣🇹🇭...")

...
21.║✍ ตั้งเข้า;
22.║✍ เปิดกัน ↔ ปิดกัน
23.║✍ กันลิ้ง ↔ ปิดกันลิ้ง
24.║✍ กันยก ↔ ปิดกันยก
25.║✍ กันเชิญ ↔ ปิดกันเชิญ
26.║✍ กันกลุ่ม ↔ ปิดกันกลุ่ม
27.║✍ กันเข้า ↔ ปิดกันเข้า
28.║✍ เปิดหมด ↔ ปิดหมด
╭═══════════════════╮
   😈_ຜู้คุມกาມlทW_😈
╭═══════════════════╮
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "😈_ຜู้คุມกาມlทW_😈")
...
#==============================================================================#
                    ...
                    msg.contentType = 13
                    line.sendMessage(to, "☠️™>ທีಖএণЮ🔝༻ສາຢບ ິЊ☠️\n☠ທีಖএণЮ🔝༻ສາຢlບsิЊ☠\nທีಖএণЮ🔝༻€มทู๓น้๏€☠\n☆~😈_ຜู้คุມกาມlทW_😈~❦")
					#line.sendContact(to, "u2e521e709e8ddfc4e3a452c509cfe7cf")
                    line.sendContact(to, "ud32fc6154159e31972a02df230ff5690")
                    line.sendContact(to, "u66e789a5df7c6abb8cd457a8c542e9b6")
                    line.sendContact(to, "u0af02eb7ec9a47cc16ffd5d12d10961f")
                    line.sendContact(to, "u4e89efa58b5a50e0230596b1793e8506")
                    line.sendContact(to, "u669aa92773d33c22420105d4546fccdd")
                    line.sendContact(to, "cb809b4416336a0cd70b21da339f2c6d6")    
                    line.sendMessage(to, "ටछๅՌζҨ້ໃのਙஆๅ๛も௮ີີ ઈऩັງ\n😽_วາຢŠາຢท่าเຢอะ_😽\n꧁༒YIM:lทW༒꧂")
#===========
...
#==============================================================================#
                    ...
                    line.sendContact(to, "u669aa92773d33c22420105d4546fccdd")
                    line.sendContact(to, "cb809b4416336a0cd70b21da339f2c6d6")
                    line.sendContact(to, "u1296443bfa9a00513265e6f72249e107")
                    line.sendContact(to, "ue9d7c66fc44cdf565441830dad15eaf3")
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("😈_ຜู้คุມกาມlทW_😈",mi_d)
                               line.sendText(msg.to,"[😈_ຜู้คุມกาມlทW_😈]")
                               line.createGroup("😈_ຜู้คุມกาມlทW_😈",mi_d)
                               line.sendText(msg.to,"[😈_ຜู้คุມกาມlทW_😈]")
                               line.createGroup("😈_ຜู้คุມกาມlทW_😈",mi_d)
                               line.sendText(msg.to,"[😈_ຜู้คุມกาມlทW_😈]")
                    ...
                    for g in gs.members:
                        ...
                        line.createGroup("♻☆~😈_ຜู้คุມกาມlทW_😈~❦ ♻",[key])
                        line.sendText(msg,to,"❋ทำการรัน สำเร็จ❋")
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "😈_ຜู้คุມกาມlทW_😈\n❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
